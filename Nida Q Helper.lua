...
function OnLoad()
  ...
  Config.misc:addParam("pro", "Prodiction To Use:", SCRIPT_PARAM_LIST, 1, {"VPrediction","Prodiction","DivinePred"})
  Config.misc:addParam("qqq", "--------------------------------------------------------", SCRIPT_PARAM_INFO,"")
...
function ThrowQ(unit)
  if unit and Q.Ready() and ValidTarget(unit) then
    ...
    if Config.misc.pro == 2 and VIP_USER and prodstatus then
    ...
    if Config.misc.pro == 3 and VIP_USER then
