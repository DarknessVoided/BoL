return {
	...
	["Darius"] = {
		...
		[_R] = { name = "", range = 450, dmgTRUE = function(source, target, stacks) return math.floor(10*source:GetSpellData(_R).level+0.75*source.addDamage+0.2*stacks*(10*source:GetSpellData(_R).level+0.75*source.addDamage)) end}
	},
	["Diana"] = {
