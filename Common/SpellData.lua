return {
	...
	["Nidalee"] = {
		[_Q] = { name = "JavelinToss", speed = 1350, delay = 0.25, range = 1625, width = 37.5, collision = true, type = "linear", dmgAP = function(source, target) return (30+20*source:GetSpellData(_Q).level+0.4*AP)*max(1,min(3,GetDistance(target.pos)/1250*3)) end}
	},
	["Nocturne"] = {
