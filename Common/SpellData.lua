return {
    ...
    ["Vayne"] = {
        ...
        [_E] = { name = "", speed = 2000, delay = 0.25, range = 600, width = 0, collision = false, aoe = false, type = "linear", dmgAD = function(source, target) return 10+35*source:GetSpellData(_E).level+0.5*source.addDamage end},
        [_R] = { range = 1000}
    },
    ["Veigar"] = {
