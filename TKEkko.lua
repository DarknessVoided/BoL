...
function Ekko:Draw()
  ...
  if self.Config.Drawing.R and self.myEvilTwin ~= nil then
    for i=1,3 do
      LagFree(self.myEvilTwin.x, self.myEvilTwin.y, self.myEvilTwin.z, 450, 5, ARGB(255, 0, 155, 155), 3, (math.pi/(1))*(i-1))
    end 
    LagFree(self.myEvilTwin.x, self.myEvilTwin.y, self.myEvilTwin.z, 450, 5, ARGB(255, 0, 155, 155), 6, 0)
  end
