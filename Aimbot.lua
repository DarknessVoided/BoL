...
function Aimbot:Vars()
    ...
    self.opcs = {{0x50, 0x82, 0xD0, 0x05, 0x3E}, {0x9B, 0x6B, 0x6A, 0x69, 0x68}, {0x09, 0xC8, 0xF7, 0xF2, 0x33}, {0x10B, 0x68, 0xEE, 0xB1, 0xCE}, {0x87, 0xEC, 0x6C, 0x74, 0x98}, {0x00E9, 0x02, 0xD8, 0xB3, 0xE7}}
    self.opcpos = {8, 10, 27, 27, 23, 27}
