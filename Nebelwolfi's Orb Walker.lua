_G.NebelwolfisOrbWalkerVersion = 0.41
...
class "NebelwolfisOrbWalker" -- {
  ...
  function NebelwolfisOrbWalker:Update()
    CScriptUpdate(_G.NebelwolfisOrbWalkerVersion, true, "raw.githubusercontent.com", "/nebelwolfi/BoL/master/Nebelwolfis%20Orb%20Walker.version", "/nebelwolfi/BoL/master/Nebelwolfi%27s%20Orb%20Walker.lua?rand="..math.random(1,10000), SCRIPT_PATH.."Nebelwolfi's Orb Walker.lua", function() end, function() end, function(NewVersion,OldVersion) print("<font color="#ff0000">[</font><font color="#ff2000">N</font><font color="#ff4000">e</font><font color="#ff5f00">b</font><font color="#ff7f00">e</font><font color="#ff9f00">l</font><font color="#ffbf00">w</font><font color="#ffdf00">o</font><font color="#ffff00">l</font><font color="#ccff00">f</font><font color="#99ff00">i</font><font color="#66ff00">'</font><font color="#33ff00">s</font><font color="#00ff00"> </font><font color="#00ff40">O</font><font color="#00ff80">r</font><font color="#00ffbf">b</font><font color="#00ffff"> </font><font color="#00bfff">W</font><font color="#0080ff">a</font><font color="#0040ff">l</font><font color="#0000ff">k</font><font color="#2300ff">e</font><font color="#4600ff">r</font><font color="#6800ff">]</font><font color="#8b00ff">:</font> <font color=\"#FFFFFF\">Updated. (v"..OldVersion.." -> v"..NewVersion..")</font>") end, function() print("<font color=\"#6699ff\"><b>[Nebelwolfi's Orb Walker]: </b></font> <font color=\"#FFFFFF\">Error downloading version info</font>") end)
    CScriptUpdate(_G.NebelwolfisOrbWalkerVersion, true, "raw.githubusercontent.com", "/nebelwolfi/BoL/master/Nebelwolfis%20Orb%20Walker.version", "/nebelwolfi/BoL/master/Nebelwolfi%27s%20Orb%20Walker.lua?rand="..math.random(1,10000), LIB_PATH.."Nebelwolfi's Orb Walker.lua", function() end, function() end, function(NewVersion,OldVersion) end, function() end)
  end
    ...
    if unit and spell and spell.name then
      if unit.isMe then
        if spell.name:lower():find("attack") or self.altAttacks[spell.name:lower()] then
          local windUp = myHero.charName == "Kalista" and 0 or spell.windUpTime
