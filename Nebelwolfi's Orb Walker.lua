_G.NebelwolfisOrbWalkerVersion = 0.40
...
class "NebelwolfisOrbWalker" -- {
  ...
  function NebelwolfisOrbWalker:Update()
    CScriptUpdate(_G.NebelwolfisOrbWalkerVersion, true, "raw.githubusercontent.com", "/nebelwolfi/BoL/master/Nebelwolfis%20Orb%20Walker.version", "/nebelwolfi/BoL/master/Nebelwolfi%27s%20Orb%20Walker.lua?rand="..math.random(1,10000), SCRIPT_PATH.."Nebelwolfi's Orb Walker.lua", function() end, function() end, function(NewVersion,OldVersion) print("<font color=\"#6699ff\"><b>[Nebelwolfi's Orb Walker]: </b></font> <font color=\"#FFFFFF\">Updated. (v"..OldVersion.." -> v"..NewVersion..")</font>") end, function() print("<font color=\"#6699ff\"><b>[Nebelwolfi's Orb Walker]: </b></font> <font color=\"#FFFFFF\">Error downloading version info</font>") end)
