...
-- { Global functions
  ...
  function OnLoad()
    ...
    champList = { "Ahri", "Ashe", "Blitzcrank", "Brand", "Cassiopeia", "Darius", "Ekko", "Kalista", "Katarina", "KogMaw", 
                  "LeeSin", "Lux", "Malzahar", "Nidalee", "Orianna", "Rengar", "Riven", "Ryze", "Rumble", "Teemo", 
                  "Vayne", "Volibear" }
                  --[[
                  TODO:
                  "Azir",
...
class "Kalista"
  ...
  function Kalista:ProcessSpell(unit, spell)
    if not unit or not spell or GetDistance(unit) > 800 then return end
  ...
  function Kalista:Tick()
    ...
    if soulMate.health/soulMate.maxHealth < 0.15 then
      self.saveAlly = true
    else
      self.saveAlly = false
    end
