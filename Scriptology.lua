...
-- { Scriptology Loader
  ...
  function SilentUpdate()
    DownloadFile("https://raw.github.com/nebelwolfi/BoL/master/SPlugins/Awareness.lua?no-cache="..math.random(1, 25000), LIB_PATH.."Scriptology - Walk.lua", function() end)
    DownloadFile("https://raw.github.com/nebelwolfi/BoL/master/SPlugins/Evade.lua?no-cache="..math.random(1, 25000), LIB_PATH.."Scriptology - Walk.lua", function() end)
