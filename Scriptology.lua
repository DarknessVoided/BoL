...
-- { Scriptology Loader
  ...
  function Load()
    if FileExist(LIB_PATH .. "ScriptologyLib.lua") and FileExist(LIB_PATH .. "SPrediction.lua") then
      ...
      if ScriptologyDebug then
        ...
        _G.loadedSPlugin = _G[myHero.charName]()
        AfterLoad()
        ...
        if CheckForPlugin(myHero.charName) then
          DelayAction(function() 
            ...
            if pcall(require, "Scriptology - "..myHero.charName) then 
              ...
              ScriptologyMsg("Plugin: '"..myHero.charName.."' loaded")
              _G.ScriptologyLoaded = true
              loadedSPlugin = _G[myHero.charName]()
              AfterLoad()
            else
  ...
  function SilentUpdate()
    ...
    if loadedSPlugin then
      DownloadFile("https://raw.github.com/nebelwolfi/BoL/master/SPlugins/"..myHero.charName..".lua?no-cache="..math.random(1, 25000), LIB_PATH.."Scriptology - "..myHero.charName..".lua", function() end)
    end
  end
