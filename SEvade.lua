_G.NebelwolfisEvadeVersion = 0.35
_G.NebelwolfisEvadeInit    = true
...
DelayAction(function()
  if not _G.NebelwolfisEvadeLoaded then
    now = NebelwolfisEvade()
  end
end, 0.25)

class "NebelwolfisEvade"

  function NebelwolfisEvade:__init()
    _G.Evade = false
    ScriptologyConfig:addSubMenu("NebelwolfisEvade", "NebelwolfisEvade")
    self.Config = ScriptologyConfig.NebelwolfisEvade
  ...
  function NebelwolfisEvade:Load()
  ...
  function NebelwolfisEvade:Dodge()
  ...
  function NebelwolfisEvade:FindSafeSpot(s,p,w,b)
    if Target then
  ...
  function NebelwolfisEvade:Draw()
  ...
  function NebelwolfisEvade:DrawRectangleOutline(startPos, endPos, pos, width)
  ...
  function NebelwolfisEvade:GetGroundTime(unit, spell)
  ...
  function NebelwolfisEvade:ProcessSpell(unit, spell)
